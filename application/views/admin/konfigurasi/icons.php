...
<div class="form-group">
    ...
    <div class="col-md-8">
    <input type="file" name="icons" class="form-control" placeholder="icons" value="<?php echo $konfigurasi->icons ?>" > 
    Icons lama: <img src="<?php echo base_url('assets/upload/image/'.$konfigurasi->icons )?>" alt="" class="img img-responsive img-thumbnail">
</div>
</div>
