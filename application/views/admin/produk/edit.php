...
<div class="form-group">
    ...
    <div class="col-md-8">
    <input type="text" name="kode_produk" class="form-control" placeholder="Kode Produk" value="<?php echo $produk->kode_produk ?>" > 
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-8">
        <select name="id_kategori" id="" class="form-control">
            ...
            <option value="<?php echo $k->id_kategori?>" <?php if($produk->id_kategori==$k->id_kategori) { echo "selected" ; }?>>
...
<div class="form-group">
    ...
    <div class="col-md-8">
    <input type="text" name="stok" class="form-control" placeholder="Stok Produk" value="<?php echo $produk->stok ?>" required> 
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-8">
        <textarea name="keywords" id="editor" class="form-control" placeholder="Keyword"><?php echo $produk->keywords ?></textarea>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-8">
    <input type="file" name="gambar" class="form-control" placeholder="Gambar Produk" value="<?php echo $produk->gambar ?>" > 
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-8">
        <select name="status_produk" class="form-control" >
            ...
            <option value="Draft" <?php if($produk->status_produk=="Draf") { echo "selected" ; } ?>>Draft</option>
        </select>
    </div>
</div>
